# Znalostní báze — Příšera týdne (Monster of the Week)

Strukturovaný přehled pravidel a herních systémů. Slouží jako základ pro
vývoj nástrojů v projektu motw-tools.

## Obsah

| Soubor | Obsah |
|--------|-------|
| [01-zaklady-hry.md](01-zaklady-hry.md) | Jak hra funguje, průběh sezení, příprava Strážce |
| [02-tvorba-zahady.md](02-tvorba-zahady.md) | 6 elementů záhady, odpočet, návnady, vzorová záhada |
| [03-hrozby.md](03-hrozby.md) | Příšery (12 typů), přisluhovači, přihlížející, lokality, fenomén |
| [04-lovci-a-playbooky.md](04-lovci-a-playbooky.md) | Atributy, tahy, 12 playbooků s detaily, zranění, štěstí |
...
- Oficiální pravidla (česká verze)
- NotebookLM analýza pravidel
- Průběžně doplňováno

## Jak rozšiřovat

1. Nové informace přidávej do příslušného souboru
2. Nové kategorie = nový soubor s prefixem čísla (08-xxx.md)
3. Aktualizuj tabulku stavu pokrytí v tomto README
4. Aktualizuj datum „Poslední aktualizace" v hlavičce souboru
